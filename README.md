...
The full rule book is available in English: [WarHorn-Borderline-Rules_EN.txt](WarHorn-Borderline-Rules_EN.txt) (v6.2); the latest rules are in [《战争号角-边境线》规则书 v7.3.md](《战争号角-边境线》规则书 v7.3.md).
