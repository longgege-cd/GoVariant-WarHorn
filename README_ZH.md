...
1. **围空分**：在对方领土或边境线形成包围圈，圈内每点 +2
2. **歼灭分**：在己方领土或边境线提吃对方棋子 → +3/子
3. **围困分**：包围对方无两眼且空间不足的棋子 → +2/子（实时动态）
...
完整规则书见 [战争号角-边境线规则文档.txt](战争号角-边境线规则文档.txt)（v6.2），最新规则见 [《战争号角-边境线》规则书 v7.3.md](《战争号角-边境线》规则书 v7.3.md)。
